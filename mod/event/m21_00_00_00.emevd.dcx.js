...
$Event(0, Default, function() {
    ...
    // [Veteran] messaggio "tracce spettrali"
    InitializeCommonEvent(0, 90005617, 72101, 420000);
    // [Veteran] Grazia argentata (grazia shadow keep main gate plaza)
    InitializeCommonEvent(0, 90005103, 72101, 72101, 21001853, 1040648000, 4, 1040648000, 1040648001, 1040648002, 1040648003, 1040648004, 1040648005, 1040648006, 1040648007, 1040648008, 1040648009);
});
...
$Event(21002850, Restart, function() {
    ...
    SetEventFlagID(21000850, ON);
    SetEventFlagID(9144, ON);
    if (PlayerIsInOwnWorld()) {
        SetEventFlagID(61144, ON);
    }
});
