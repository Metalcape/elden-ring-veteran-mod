...
$Event(0, Default, function() {
    ...
    // TEST guidance of grace (different SFX)
    // InitializeCommonEvent(0, 90005103, 71001, 76101, 1042361982, 77100, 5, 78100, 78101, 78102, 78103, 78104, 78105, 78106, 78107, 78108, 78109);
    //
