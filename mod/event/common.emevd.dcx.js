...
$Event(0, Default, function() {
    ...
    InitializeEvent(0, 1700, 0);
    // [Veteran] Super binoculars
    InitializeEvent(0, 1040641000, 10000);
    // [Veteran] NG+ speffect
...
// Super binoculars
$Event(1040641000, Restart, function(X0_4) {
    if(PlayerHasItem(ItemType.Goods, 42000)) {
        WaitFor(CharacterHasSpEffect(X0_4, 3240));
        SetCharacterTeamType(X0_4, TeamType.Disabled);
        WaitFor(CharacterHasSpEffectState(X0_4, 3240, false));
